    ...
    return (
        <div className="flex flex-1 flex-col gap-y-4">
            <textarea
                ...
                ref={textAreaRef} name="content" rows={2} className={`p-2 w-full text-2xl ${ bgColor ||'bg-black' } placeholder-gray-500 resize-none`} placeholder={`${placeholder || 'What is happening?!'}`}></textarea>
